...
public:
    ...
    virtual FileSystemStatus read_block(int block_index, std::uint8_t *buffer) const = 0;

    virtual FileSystemStatus write_block(int block_index, const std::uint8_t *buffer) = 0;
};